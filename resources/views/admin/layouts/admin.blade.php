...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/admin/fontawesome/css/fontawesome-all.css')}}">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item ">
                            ...
                            <div id="submenu-1" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-{{$category->id}}" aria-controls="submenu-1-{{$category->id}}">{{$category->description}}</a>
                                        <div id="submenu-1-{{$category->id}}" class="collapse submenu" style="">
                                            <ul class="nav flex-column">
                                                ...
                                                @endforeach
                                                <li class="nav-item">
                                                    <a class="nav-link" href="{{ route('admin.danhmuc',['id' => $category->id])}}">+ Tùy chỉnh</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-3" aria-controls="submenu-3"><i class="fas fa-fw fa-chart-pie"></i>Quản lý doanh thu</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('admin.createNews')}}" aria-controls="submenu-3"><i class="fas fa-fw fa-chart-pie"></i>Tin tức</a>
                        </li>        
                        <li class="nav-item">
